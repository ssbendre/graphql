...
export class AppComponent {
  ...
  fillerNav = [
    ...
    {link: '/semen-info', label: 'वीर्य माहिती', icon: 'event_note'},
    {link: '/visiting-info', label: 'भेटीची माहिती', icon: 'event_note'},
    {link: '/reports', label: 'अहवाल', icon: 'event_note'},
    {link: '/new-user', label: 'नवीन वापरकर्ता नोंदणी', icon: 'event_note'},
