...
export class AppComponent {
  ...
  fillerNav = [
    ...
    {link: '/new-semen', label: 'नवीन वीर्य ब्रँड जतन करा', icon: 'offline_bolt'},
    {link: '/semen-buyer', label: 'वीर्य खरेदीदार यादी', icon: 'add_shopping_cart'},
    {link: '/semen-list', label: 'वीर्य यादी', icon: 'dashboard'}
  ];
