import { Component, TemplateRef, ElementRef, OnInit, AfterContentInit } from '@angular/core';
...
export class AppComponent {
  ...
  constructor(private apollo: Apollo, private modalService: BsModalService, private el: ElementRef) { 
  }
  ...
  ngAfterContentInit() {
    // Grab the DOM
    console.log(this.el.nativeElement.querySelectorAll('.text-center'));
    console.log(this.el.nativeElement.querySelectorAll('.row'));
  }
    ...
    this.apollo
      .mutate({
        ...
        update: (proxy, { data: { updateUser } }) => {
          ...
          console.log('user.name',data.users[index])
